library customizable_scrollbar;

import 'package:customizable_scrollbar/src/bar_position.dart';
import 'package:customizable_scrollbar/src/nullable_edge_insets.dart';
import 'package:customizable_scrollbar/src/scrollbar_info.dart';
import 'package:flutter/material.dart';

typedef ScrollWidgetBuilder = Widget Function(ScrollbarInfo);

class CustomizableScrollbar extends StatefulWidget {
  ...
  @override
  State<CustomizableScrollbar> createState() => _CustomizableScrollbarState();
}

class _CustomizableScrollbarState extends State<CustomizableScrollbar> {
  ...
  Size? scrollLabelSize = const Size(0, 0);
